...
public class FirstSceneScript : MonoBehaviour, ILangListener
{
    ...
    //    dialogTexts.Add(new DialogData("/size:up/Hi, /size:init/" + GameManager.Instance.LangManager.GetTranslate("Scn_Test"), "Li"));
    ...
    //public void InitializeDialog(Language actualLanguage)
    //{
    //    GameManager.Instance.LangManager.ChangeLanguage(actualLanguage);
    ...
    private void Update()
    {
        ...
        {
            Debug.Log(GameManager.Instance.LangManager.GetTranslate("ScnTest"));
        }
    }
}
